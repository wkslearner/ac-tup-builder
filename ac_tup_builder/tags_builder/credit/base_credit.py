...
class CreditTagsBuilder(TagsBuilder):
    ...
    def build_tags(self, dataContext: DataContext, tupRecordService: TupRecordService):
        ...
        # 未销户人民币信用卡张数
        logger.info('Prepare to build tup by number_uncanceledCNYcreditcard')
        ...
        # 信用卡额度总和
        logger.info('Prepare to build tup by number_total_crditLine')
        ...
        # 信用卡已用额度总和
        logger.info('Prepare to build tup by number_total_crditLine_used')
        ...
        # 信用卡额度使用率
        logger.info('Prepare to build tup by usage_of_crditLine')
        usage_of_crditLine = []
        ...
        # 呆账信用卡数
        logger.info('Prepare to build tup by number_of_creditcardbadebts')
        ...
        # 信用卡是否当前逾期
        logger.info('Prepare to build tup by card_result')
        ...
        # 贷款是否当前逾期
        logger.info('Prepare to build tup by lean_result')
        ...
        # 逾期90天及以上信用卡数
        logger.info('Prepare to build tup by over_card_result')
        ...
        # 逾期90天及以上贷款数
        logger.info('Prepare to build tup by over_loan_result')
        ...
        # 临柜查询次数
        logger.info('Prepare to build tup by number_of_countercheck')
        ...
        # 互联网个人查询次数
        logger.info('Prepare to build tup by number_of_onlinecheck')
        ...
        # 信用卡审批次数
        logger.info('Prepare to build tup by number_of_creditcardapply')
        ...
        # 芝麻信用反欺诈分
        logger.info('Prepare to build tup by score_of_zmxyantifruadlist')
